...
seconds_flag:  dbit 1
fsm_done:      dbit 1 ;flag used to detect whether fsm has done
...
;------------------------------------;
; Play degrees, set the degree value ;
; to the parameter 'degree' before   ;
; use.                               ;
;------------------------------------;
Play_Degrees:
	setb T2S_FSM_Start
forever_loop:
    ...
    ret		
;------------------------------------;
; Play sound my index, set the index ;
; want to play to the parameter 'a'  ;
; before use.                        ;
;------------------------------------;  
Play_By_Index:  
	lcall Play_Sound_Using_Index
