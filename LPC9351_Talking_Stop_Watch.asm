...
sound_index:
    ...
    db 0x08, 0x3a, 0xb5 ; 20--20 -------------change made by steven 
    db 0x08, 0x8e, 0xee ; 21--30
    db 0x09, 0x01, 0x10 ; 22--40 
    db 0x09, 0x4a, 0x00 ; 23--50 
    db 0x09, 0xca, 0x99 ; 24--60 
    db 0x0a, 0x1a, 0x00 ; 25--70 
    db 0x0a, 0xa9, 0x00 ; 26--80 --not used  
    db 0x0a, 0x99, 0x00 ; 27--80 
    db 0x0b, 0x0f, 0x00 ; 28--90 
    db 0x0b, 0x5a, 0x00 ; 29--100 
    db 0x0b, 0xca, 0x00 ; 30--200 
    db 0x0c, 0x3f, 0x00 ; 31--the current state is  
    db 0x0c, 0xc0, 0x00 ; 32--the current temperature is 
    db 0x0d, 0x34, 0x00 ; 33--too hot 
...
; Test that we can play any sound from the index
	mov a, #1 ;--the number we want to produce
	lcall Play_Sound_Using_Index
